...
public class Util {
    ...
    // add double num to double array and returns array
    ...
    // add Integer num to Integer array and returns array
    ...
    // add char ch to char array and returns array

    public static Character[] addElement(Character[] arr,Character ch){
    ...
    // add Character ch to Character array and returns array
    ...
    // add String str to String array and returns array
